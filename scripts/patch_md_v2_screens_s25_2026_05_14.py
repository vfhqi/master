#!/usr/bin/env python3
# =============================================================================
# patch_md_v2_screens_s25_2026_05_14.py
# -----------------------------------------------------------------------------
# Session 25 (14-May-26) rewrite of the pre-test indicator / capital
# qualification setup / capital deployment test logic in _md_v2_screens.py.
...
TARGET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_md_v2_screens.py")
MARKER = "MD-V2-SCREENS-S25-MARKER"
...
def main():
    ...
    backup = TARGET + ".bak-pre-md-v2-screens-s25-" + ts
    ...
    new_len = len(src)
    print("OK: _md_v2_screens.py patched.")
